...
public class MainActivity extends Activity {
	...
	// Put your plugin in the assets-folder under 'plugin.js' and start this app for testing. 
	// In case of errors, the method loadWebView() should be considered first.
	...
	public class PlaceholderFragment extends Fragment {
		...
		public void loadWebView() {
			...
			try {
				...
				final String onPageFinishedLoadUrl1 = replace(myObj.optString(
						"onPageFinishedLoadUrl1", null));
				final String onPageFinishedLoadUrl2 = replace(myObj.optString(
						"onPageFinishedLoadUrl2", null));
				final String onPageFinishedLoadUrl3 = replace(myObj.optString(
						"onPageFinishedLoadUrl3", "text/html"));
				final String onPageFinishedLoadUrl4 = replace(myObj.optString(
						"onPageFinishedLoadUrl4", "utf-8"));
				...
				if (DEBUG) {
					...
					Log.i("HAG", "onPageFinishedLoadUrl1: " + onPageFinishedLoadUrl1);
					Log.i("HAG", "onPageFinishedLoadUrl2: " + onPageFinishedLoadUrl2);
					Log.i("HAG", "onPageFinishedLoadUrl3: " + onPageFinishedLoadUrl3);
				...
				wv.setWebViewClient(new WebViewClient() {
					...
					public void onPageFinished(WebView view, String url) {
						if (!((onPageFinishedLoadUrl2 == null) || onPageFinishedLoadUrl2
								.isEmpty())) {
							super.onPageFinished(wv, url);
							wv.loadDataWithBaseURL(onPageFinishedLoadUrl1,
									onPageFinishedLoadUrl2, onPageFinishedLoadUrl3,
									onPageFinishedLoadUrl4, onPageFinishedLoadUrl5);
